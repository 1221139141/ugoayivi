    ...
    <main className="mt-20 text-center">
      ...
      <div className="h-full flex justify-center bg-[#fefce8] border-3">
        <div className="w-2/3 p-20 text-justify">
          ...
          <div className="text-2xl mb-4 font-[Geist]">Après une première expérience en juridiction au Tribunal judiciaire de xx, il a débuté son activité professionnelle au sein d&apos;un cabinet pénaliste xx de renom, dont ceux de xx. Ces premières expériences lui ont permis d&apos;acquérir de solides compétences dans la gestion de problématiques juridiques complexes.</div>
          <div className="text-2xl mb-4">
          ...
          <div className="text-2xl mb-4">
          Passionné par la défense pénale et l&apos;art oratoire, il a été élu Premier Secrétaire de la Conférence du stage du barreau de Bordeaux pour l&apos;année 2023.
